...
BDDIRegInfo ast_MemoryUtilityRegInfo[] = 
{
...
BDDIParInfo ast_MemoryUtilityParInfo[] = 
{
	{"p_Base_Addr", 32, BDDIParTypeUINT, ""},
	{"p_Addr_Size", 32, BDDIParTypeUINT, ""}
};

static const UINT32 dw_RegCnt = sizeof(ast_MemoryUtilityRegInfo) / sizeof(ast_MemoryUtilityRegInfo[0]);
static const UINT32 dw_ParCnt = sizeof(ast_MemoryUtilityParInfo) / sizeof(ast_MemoryUtilityParInfo[0]);
...
MemoryUtility_BDDI::MemoryUtility_BDDI(MemoryUtility *c) : p_Target(c)
{
	...
	for(dw_Index=0; dw_Index<dw_RegCnt; dw_Index++)	{
		strcpy(pst_OutRegInfo[dw_Index].Name,					ast_MemoryUtilityRegInfo[dw_Index].Name);
		pst_OutRegInfo[dw_Index].Bitswide						= ast_MemoryUtilityRegInfo[dw_Index].Bitswide;
		pst_OutRegInfo[dw_Index].Type								= ast_MemoryUtilityRegInfo[dw_Index].Type;
	}

	for(dw_Index=0; dw_Index<dw_ParCnt; dw_Index++)	{
		strcpy(pst_OutParInfo[dw_Index].Name,					ast_MemoryUtilityParInfo[dw_Index].Name);
		pst_OutParInfo[dw_Index].Bitswide						= ast_MemoryUtilityParInfo[dw_Index].Bitswide;
		pst_OutParInfo[dw_Index].Type								= ast_MemoryUtilityParInfo[dw_Index].Type;
...
BDDIReturn MemoryUtility_BDDI::BDDIGetRegisterValues(unsigned int RegIndex, char *OutValue)
{
	...
	switch(RegIndex)
	{
		case 0:
			...
			BDDIPutInRegisterValue(&st_Temp, &ast_MemoryUtilityRegInfo[RegIndex], &r_MU_SRC_ADDR_temp);
		...
		case 1:
			...
			BDDIPutInRegisterValue(&st_Temp, &ast_MemoryUtilityRegInfo[RegIndex], &r_MU_DST_ADDR_temp);
			BDDIConvertRegisterValueToString(&st_Temp, OutValue);
		...
		case 2:
			...
			BDDIPutInRegisterValue(&st_Temp, &ast_MemoryUtilityRegInfo[RegIndex], &r_MU_VALUE_temp);
			BDDIConvertRegisterValueToString(&st_Temp, OutValue);
		...
		case 3:
			...
			BDDIPutInRegisterValue(&st_Temp, &ast_MemoryUtilityRegInfo[RegIndex], &r_MU_SIZE_temp);
			BDDIConvertRegisterValueToString(&st_Temp, OutValue);
		...
		case 4:
			...
			BDDIPutInRegisterValue(&st_Temp, &ast_MemoryUtilityRegInfo[RegIndex], &r_MU_RESULT_temp);
			BDDIConvertRegisterValueToString(&st_Temp, OutValue);
		...
		case 5:
			...
			BDDIPutInRegisterValue(&st_Temp, &ast_MemoryUtilityRegInfo[RegIndex], &r_MU_CMD_temp);
			BDDIConvertRegisterValueToString(&st_Temp, OutValue);
		...
		case 6:
			...
			BDDIPutInRegisterValue(&st_Temp, &ast_MemoryUtilityRegInfo[RegIndex], &r_MU_UNITSTEP_temp);
			BDDIConvertRegisterValueToString(&st_Temp, OutValue);
...
BDDIReturn MemoryUtility_BDDI::BDDISetRegisterValues(unsigned int RegIndex, const char *SetValue)
{
	...
	{
		case 0:
			BDDIConvertStringToRegisterValue(&st_Temp, &ast_MemoryUtilityRegInfo[RegIndex], SetValue);
...
BDDIReturn MemoryUtility_BDDI::BDDIGetParameterValues(unsigned int ParIndex, char *OutValue)
{
	...
	switch(ParIndex)
	{
		case 0:
			...
			BDDIPutInParameterValue(&st_Temp, &ast_MemoryUtilityParInfo[ParIndex], &p_Base_Addr_temp);
		...
		case 1:
			...
			BDDIPutInParameterValue(&st_Temp, &ast_MemoryUtilityParInfo[ParIndex], &p_Addr_Size_temp);
			BDDIConvertParameterValueToString(&st_Temp, OutValue);
...
BDDIReturn MemoryUtility_BDDI::BDDISetParameterValues(unsigned int ParIndex, const char *SetValue)
{
	...
	{
		case 0:
			BDDIConvertStringToParameterValue(&st_Temp, &ast_MemoryUtilityParInfo[ParIndex], SetValue);
