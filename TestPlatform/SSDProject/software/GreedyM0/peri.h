...
#define APB_ICU_CON			(0xB5000000 + 0x000)			//is changed by TB
#define APB_INT_MSK			(0xB5000000 + 0x00C)			//is changed by TB
#define APB_INT_STS			(0xB5000000 + 0x004)			//is changed by TB
#define APB_PRI_SET1		(0xB5000000 + 0x054)			//is changed by TB
#define APB_PRI_SET2		(0xB5000000 + 0x058)			//is changed by TB
