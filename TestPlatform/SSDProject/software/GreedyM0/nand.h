...
#elif FLASH_TYPE == K9F1G08U0E
	#define NAND_SPEC_ID			0x419500F1
	#define NAND_SPEC_ID_MASK		0xFFFFFFFF
	#define NAND_SPEC_MF			NAND_SPEC_SAMSUNG
	#define NAND_SPEC_PLANE 		NAND_SPEC_PLANE_1
	#define NAND_SPEC_DIE			NAND_SPEC_DIE_1
	#define NAND_SPEC_CELL			NAND_SPEC_CELL_SLC
	#define NAND_SPEC_SPEED 		NAND_SPEC_FAST
	//#define NAND_SPEC_MLC			NAND_SPEC_MLC_TYPE_2		// Not used. Because it is SLC NAND FLASH.
	#define NAND_SPEC_READ			NAND_SPEC_READ_CYCLE_2
	#define SECTORS_PER_PHYPAGE 	4
	#define PAGES_PER_VBLK		    16
	#define _PBLKS_PER_BANK 	    512
	#define SPARE_PBLKS_PER_BANK	0
	#define SPARE_PER_PHYPAGE		0
