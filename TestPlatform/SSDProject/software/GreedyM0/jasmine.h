...
#define	FLASH_TYPE		K9F1G08U0E	// is changed by TB
#define	DRAM_SIZE		65075200
#define	BANK_BMP		0x000F		// is changed by TB
...
#define OPTION_Print	 1	// SoC designer print by TB 

#define CHN_WIDTH			1 	// 2 = 16bit IO		// is changed by TB
...
#include "target.h"
#include "bank.h"
#include <stdio.h>		// is changed by TB
