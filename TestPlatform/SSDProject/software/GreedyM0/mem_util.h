...
#define	MU_SRC_ADDR 	(MU_BASE + 0x10)
#define	MU_DST_ADDR 	(MU_BASE + 0x14)
#define	MU_VALUE   		(MU_BASE + 0x18)
#define	MU_SIZE    		(MU_BASE + 0x1C)		// max 32768 bytes for mem_set, mem_find, 32768 items for mem_search
#define	MU_RESULT  		(MU_BASE + 0x20)
#define	MU_CMD  		(MU_BASE + 0x24)
#define MU_UNITSTEP		(MU_BASE + 0x30)		// step <= 32 bytes
