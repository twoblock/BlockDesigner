...
public class OpenAboutTwoblock extends AbstractHandler {
...
//		  registry.put("icon", ImageDescriptor.createFromFile(OpenAboutTwoblock.class, "src/twoblock_solution.gif"));
//		}
