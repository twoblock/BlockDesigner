package kr.co.twoblocktech.block.designer.ui;
...
public class Perspective_BlockDesigner implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
	   ...
	   defineLayout(layout);
	   layout.addView("com.twoblock.e4.platform.manager.ui.views.PlatformManagerView", IPageLayout.TOP,
...
//	   PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().activate(editor);
	...
	private void defineLayout(IPageLayout layout) {
	   ...
	   // "show views"에 추가.Window->Show View
	...
	private void defineActions(IPageLayout layout) {
	   ...
	   // navigator과 outline을 editor 옆에 폴더 레이아웃안에 추가한다.
...
//	   IFolderLayout top = layout.createFolder("top", IPageLayout.TOP, (float) 0.7, editorArea);   
	...
	public interface IPerspectivePlugin {
	    ...
	    * Plugin id.
	    */
	   public final static String PLUGIN_ID = "NewPerspective.perspective";
