...
public class Handler_AboutTwoblock extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		// ImageDescriptor id = ImageDescriptor.createFromFile(this.getClass(),
		// "/images/twoblock_solution.png");
	...
	// registry.put("icon",
	// ImageDescriptor.createFromFile(Handler_AboutTwoblock.class,
	// "src/twoblock_solution.gif"));
	// }
